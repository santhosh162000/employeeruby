...
function Profile() {  
  ...
  const onSubmitHandler = async (e) => {
    e.preventDefault();
    setedit(false);
    axios.post(`https://employeerubybackend.herokuapp.com/UpdateProfile`, { profileDetails })
      .then(res => {
        console.log(res);
  ...
  const deleteHandler = async (e) => {
    e.preventDefault();
    axios.post(`https://employeerubybackend.herokuapp.com/DeleteProfile`, {profileDetails})
      .then(res => {
        console.log(res);
        console.log(res.data);
        console.log(res.status);
  ...
  if(edit)
  {
    ...
    return (
        ...
        <div className="wrapper">
        <div className="title">
        <h1>Profile <br></br><button onClick={editHandler}>Edit</button> &nbsp;<button onClick={signoutHandler}>Sign Out</button></h1>
        </div>
        <form onSubmit={onSubmitHandler}>
        <div className="form">
